...
const SOCIAL = [
  {
    name: "Instagram",
    href: "https://instagram.com/copeospil",
    icon: (
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/copeospil.cooperativadeluiggi",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
  ...
  {
    name: "WhatsApp",
    href: "https://wa.me/5492302518297",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
...
<div className={styles.footerColumn}>
          ...
          <p>
            <a href="https://www.copeospil.com.ar" target="_blank" rel="noopener noreferrer">
